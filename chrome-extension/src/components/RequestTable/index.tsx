...
export default function RequestTable(props: Props): ReactElement {
  ...
  return (
    <div className="flex flex-col flex-nowrap flex-grow  py-4">
      ...
      <div className="space-y-2 mx-4 mb-2 flex flex-col">
        <Input
          id="search"
        ...
        />
        <button
          className="cursor-pointer text-brand text-sm font-medium ml-auto block"
          onClick={reset}
        >
          Clear all requests
        </button>
            ...
            {list.map((row, index) => {
              ...
              return (
                <TableRow
                  ...
                  className="cursor-pointer hover:bg-buttonLightHover"
                >
